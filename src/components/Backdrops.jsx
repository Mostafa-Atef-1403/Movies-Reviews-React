      ...
      <div className="img-path">
        ...
        >
          <img
            ...
            srcset={`https://media.themoviedb.org/t/p/w500_and_h282_face/${img.file_path} 1x, https://media.themoviedb.org/t/p/w1000_and_h563_face/${img.file_path} 2x`}
            alt={details.title}
          />
        </a>
      </div>
